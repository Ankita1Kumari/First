...

{
	...
	printf("\n\t\t\t\t#   NIT HOSPITAL MANAGEMENT SYSTEM    #");
...

{
	...
	printf("\n\n\n\n\n\t\t\t\t1. Add Patients Record and OPD details \n");
...
char original_Username[25]="1111";

char original_Password[15]="1111";
...

{
	...
	printf("\n\n\n\n\t\t\t\tEnter your Username(1111) and Password(1111)  :)");
...
/* ********************************************** Prescribed Doctor **************************************** */	
    ...
    fprintf(ek," %s %s %c %s %s \n", p.First_Name, p.Last_Name, p.Gender, p.Problem, p.Doctor);
